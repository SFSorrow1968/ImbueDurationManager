...
- **Git Workflow**: `[_docs/GIT_WORKFLOW.md](file:///D:/Documents/Projects/repos/BS/Mods/Imbue%20Duration%20Manager/_docs/GIT_WORKFLOW.md)` (Read if pushing code/builds)
- **Design Specs**: `[_docs/DESIGN.md](file:///D:/Documents/Projects/repos/BS/Mods/Imbue%20Duration%20Manager/_docs/DESIGN.md)` (Read if changing features)
- **Publishing**: `[_docs/PUBLISH.md](file:///D:/Documents/Projects/repos/BS/Mods/Imbue%20Duration%20Manager/_docs/PUBLISH.md)` (Read if preparing release)
- **Tools**: `[_docs/TOOLS.md](file:///D:/Documents/Projects/repos/BS/Mods/Imbue%20Duration%20Manager/_docs/TOOLS.md)` (Read if using scripts)
- **Description**: `[_docs/DESCRIPTION.md](file:///D:/Documents/Projects/repos/BS/Mods/Imbue%20Duration%20Manager/_docs/DESCRIPTION.md)` (Read if updating mod description)
...
1. **Build**: Use VS Code Task `Build Active Mod` (Ctrl+Shift+B).
   - *Output*: `bin/PCVR/Imbue Duration Manager/` & `bin/Nomad/Imbue Duration Manager/`
