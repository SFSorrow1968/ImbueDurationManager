# Imbue Duration Manager Publishing Script
# Usage: ./publish.ps1
...
$projectPath = "ImbueDurationManager.csproj"
...
$pcvrZip = "Imbue Duration Manager_PCVR_v$version.zip"
$nomadZip = "Imbue Duration Manager_Nomad_v$version.zip"
